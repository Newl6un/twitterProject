        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              //lay user_id tu decoded_email_verify_token de tim user so huu
              ...
              req.user = user
              //neu co user thi xem thu user do co bi banned kh?
              ...
              //neu truyen len kh dung voi database thi bao loi
